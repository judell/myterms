...
1. **Alice** (the person) selects a privacy term to proffer -- either SD-BASE (a base-level service delivery agreement) or SD-BY-DP (controlling use of personal data for AI training)
